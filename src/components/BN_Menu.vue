<template>
    ...
    :class="[scrolled ? 'drop-shadow-2xl' : 'drop-shadow-none', globalStore.loaded2 ? 'h-24 mt-24' : 'h-screen -mt-48 pointer-events-none']">
        ...
        <div class="fixed top-0 left-0 w-full h-full bg-BN_BACKGROUND flex justify-center items-center z-[200] text-5xl text-BN_FONT_WHITE font-bold transition-all duration-1000"
            ...
            <svg :class="[globalStore.loaded2 ? 'left-[156px] -mt-[18px] h-9 drop-shadow-lg' : 'h-20 -mt-[0px] -translate-y-1/2 left-1/2 drop-shadow-2xl', globalStore.loaded1 ? '' : 'animate-pulse']" class="absolute top-1/2 -translate-x-1/2 transition-all duration-1000" viewBox="0 0 133 82" fill="none" xmlns="http://www.w3.org/2000/svg">
